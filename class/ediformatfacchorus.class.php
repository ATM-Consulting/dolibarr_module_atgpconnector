...
class EDIFormatFACChorus extends EDIFormat
{
	public static $remotePath = '/factures_chorus/';
...
class EDIFormatFACChorusSegmentATGP extends EDIFormatSegment
{
...
class EDIFormatFACChorusSegmentENT extends EDIFormatSegment
{
	public static $TFields = array(
		1 => array(
		...
		, 26 => array(
			...
			, 'data' => '! empty($conf->global->ATGPCONNECTOR_DEV_MODE) ? 1 : ""'
			, 'maxLength' => 1
			, 'required' => true
		)
		, 27 => array(
			'label' => 'Code paiement (cf table ENT.27)'
			, 'data' => '42' // Chorus n'accepte que 42
			, 'maxLength' => 3
			, 'required' => true
		)
		, 28 => array(
...
class EDIFormatFACChorusSegmentDTM extends EDIFormatSegment
{
	public static $TFields = array(
		1 => array(
...
class EDIFormatFACChorusSegmentPAR extends EDIFormatSegment
{
	public static $TFields = array(
		1 => array(
		...
		, 14 => array(
			'label' => 'Code SIRET siège social vendeur (obligatoire si différent du code SIRET vendeur)'
			, 'data' => '' // TODO
			, 'maxLength' => 13
		)
		, 15 => array(
...
class EDIFormatFACChorusSegmentPAD extends EDIFormatSegment
{
	public static $TFields = array(
		1 => array(
...
class EDIFormatFACChorusSegmentPIE extends EDIFormatSegment
{
	public static $TFields = array(
		1 => array(
